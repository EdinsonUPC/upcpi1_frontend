...
const DdownMultiSearchPersonal = forwardRef(
  ({ onChange, multiple = true, defaultValue = null }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      ...
      setValue: (x) => {
        setSelectedOptions(options.find((option) => option.value === x));
      },
    }));
...
DdownMultiSearchPersonal.displayName = "DdownMultiSearchPersonal";
