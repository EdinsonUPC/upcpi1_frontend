...
const DdownMultiSearchClient = forwardRef(
  ({ onChange, multiple = true, defaultValue = null }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      reset: () => setSelectedOptions(null),
      getValue: () => selectedOptions,
      setValue: (x) => {
        setSelectedOptions(options.find((option) => option.id === x));
      },
    }));
        ...
        try {
          ...
          if (defaultValue !== null) {
            const initial = multiple
              ...
              : dropdownOptions.find((opt) => opt.value === defaultValue) ||
                null;
...
DdownMultiSearchClient.displayName = "DdownMultiSearchClient";
